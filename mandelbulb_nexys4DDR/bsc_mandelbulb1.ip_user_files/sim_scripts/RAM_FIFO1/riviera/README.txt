...
#
# Generated by export_simulation on Thu Dec 21 02:44:06 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './RAM_FIFO1.sh' script.

./RAM_FIFO1.sh -reset_run
...
./RAM_FIFO1.sh -noclean_files

For more information on the script, please type './RAM_FIFO1.sh -help'.
