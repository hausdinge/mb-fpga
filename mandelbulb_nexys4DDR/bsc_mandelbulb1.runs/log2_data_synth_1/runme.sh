...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/bsc_mandelbulb1/bsc_mandelbulb1.runs/log2_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log log2_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source log2_data.tcl
