...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/bsc_mandelbulb2/bsc_mandelbulb2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_demo_dvi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_demo_dvi.tcl
