...
HD_PWD='C:/Users/hausd/Dateien/Xilinx_proj/bsc_mandelbulb2/bsc_mandelbulb2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_demo_dvi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_demo_dvi.tcl -notrace
