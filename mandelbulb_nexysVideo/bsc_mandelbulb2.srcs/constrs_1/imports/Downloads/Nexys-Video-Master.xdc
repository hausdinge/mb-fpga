...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { RST_BTN }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn


## Switches
set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS12 } [get_ports { sw0 }]; #IO_L22P_T3_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS12 } [get_ports { sw1 }]; #IO_25_16 Sch=sw[1]
