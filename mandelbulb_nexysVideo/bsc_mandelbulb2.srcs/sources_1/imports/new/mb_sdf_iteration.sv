...
// latency: 190 clock cycles
// mandelbulb_SDF_iteration
module mb_sdf_iteration (
...
output logic out_valid
  ...
  // We encapsulated some of the mandelbulb_SDF_iteration logic
  // in the mb_.. modules for a better overview.
