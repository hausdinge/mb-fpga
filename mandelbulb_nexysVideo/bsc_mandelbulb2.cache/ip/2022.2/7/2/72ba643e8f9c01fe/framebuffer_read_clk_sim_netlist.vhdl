...
-- Date        : Sun Feb 25 14:14:36 2024
-- Host        : DESKTOP-H9C91L2 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ framebuffer_read_clk_sim_netlist.vhdl
-- Design      : framebuffer_read_clk
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_framebuffer_read_clk_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_framebuffer_read_clk_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_framebuffer_read_clk_clk_wiz is
  signal clk_in1_framebuffer_read_clk : STD_LOGIC;
  signal clk_out1_framebuffer_read_clk : STD_LOGIC;
  signal clk_out1_framebuffer_read_clk_en_clk : STD_LOGIC;
  signal clkfbout_buf_framebuffer_read_clk : STD_LOGIC;
  signal clkfbout_framebuffer_read_clk : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_framebuffer_read_clk,
      O => clkfbout_buf_framebuffer_read_clk
    );
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      ...
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_framebuffer_read_clk
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_framebuffer_read_clk,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_framebuffer_read_clk,
      O => clk_out1_framebuffer_read_clk_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_framebuffer_read_clk,
      CLKFBOUT => clkfbout_framebuffer_read_clk,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_framebuffer_read_clk,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_framebuffer_read_clk,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_framebuffer_read_clk_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_framebuffer_read_clk_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
