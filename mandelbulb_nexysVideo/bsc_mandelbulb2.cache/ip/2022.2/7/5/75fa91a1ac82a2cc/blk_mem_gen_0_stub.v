...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, wea, addra, dina, douta, clkb, enb, web, addrb, dinb, 
  doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,wea[0:0],addra[19:0],dina[5:0],douta[5:0],clkb,enb,web[0:0],addrb[19:0],dinb[5:0],doutb[5:0]" */;
  input clka;
  input [0:0]wea;
  input [19:0]addra;
  input [5:0]dina;
